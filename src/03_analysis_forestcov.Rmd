...
my_full_area_map <- function(my_class,my_data){
  #generate title
...
sort(unique(crowns_group$crown_group_class)) %>% 
  purrr::map(my_full_area_map, my_data = crowns_group %>% sf::st_intersection(bhef_boundary))
...
# print(plot_cover_class_bars(my_unit = rx_fire$unit[8]))
```
...
# print(plot_cover_class_map(my_unit = rx_fire$unit[1]))
```
...
# print(plot_contour_map(my_unit = rx_fire$unit[1]))
```
