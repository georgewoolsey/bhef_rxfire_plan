...
# save plot
ggplot2::ggsave(
    filename = paste0("../data/pdf/cover_class_bhef_2017.pdf")
...
# save plot
ggplot2::ggsave(
    filename = paste0("../data/pdf/cover_class_bhef_noharv.pdf")
    , plot = ggplot2::last_plot()
    , width = 11
    , height = 8.5
    , units = "in"
...
# save plot
ggplot2::ggsave(
    filename = paste0("../data/pdf/cover_class_by_unit.pdf")
    , plot = ggplot2::last_plot()
    , width = 11
    , height = 8.5
    , units = "in"
