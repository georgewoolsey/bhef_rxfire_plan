...
## Download Lidar Data From Nat'l Map
...
Points-to-raster algorithm with a resolution of 1 meter. for each pixel of the output raster the function attributes the height of the highest point found.
...
### Crown Group Summary Statistics
...
sf::st_write(tree_tops.gpkg, "../data/tree_tops.gpkg", append = FALSE)
}
```
